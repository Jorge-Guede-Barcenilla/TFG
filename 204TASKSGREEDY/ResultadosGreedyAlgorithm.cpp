...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		int NumberOfTasks=0, SolutionIterations=0, NumberOfAreas=0, DesiredSolutions=20000, NumberOfProfiles=0, Area1Capacity=0, Area2Capacity=0, Area3Capacity=0, k=0, j=0, i=0, l=0, Aux1=0, Aux2=0, Aux3=0, Aux4=0, Aux5=0, Aux6=0, Aux7=0, Aux8=0,
		...
		float ExecutionTime=0,	StartTime=clock(), EndTime=0, Area1_1TotalOccupancy=0, Area1_2TotalOccupancy=0, Area1_3TotalOccupancy=0, Area1_4TotalOccupancy=0, Area1_5TotalOccupancy=0, Area2_1TotalOccupancy=0, Area2_2TotalOccupancy=0, Area2_3TotalOccupancy=0;
...
/*ESCANEO DE DATOS Y DE PRECEDENCIAS*/
	...
	fscanf(f,"%d %d %d", &Area1Capacity, &Area2Capacity, &Area3Capacity); 	
		
							}
		
	
		int	SolutionTask[NumberOfTasks], SolutionStart[NumberOfTasks], SolutionEnd[NumberOfTasks],
		AuxiliarSolutionTotalStart[NumberOfTasks], AuxiliarSolutionTotalEnd[NumberOfTasks], 
		SEED=1566, StopCounter=0, Solution=0, Makespam=10000, ScheduleEarlyStart[NumberOfTasks], 
		ScheduleStart[NumberOfTasks], ScheduleEnd[NumberOfTasks], ScheduledTask[NumberOfTasks], NumberOfIteration[DesiredSolutions],
		TotalOperatorsOfProfile1=5, TotalOperatorsOfProfile2=3, OperatorsInArea1[NumberOfTasks][aux], OperatorsInArea2[NumberOfTasks][aux];
...
for(SolutionIterations=0; SolutionIterations<1; SolutionIterations++)		{
...
/*ESCANEO DE DATOS Y DE PRECEDENCIAS*/
	...
	fscanf(f,"%d %d %d", &Area1Capacity, &Area2Capacity, &Area3Capacity); 	
		...
		int MinimumOperators[NumberOfTasks], MaximumOperators[NumberOfTasks],
		...
		State[NumberOfTasks], i=0, j=0, k=0, m=0, 
		...
		Profile1Resources[Time], Profile2Resources[Time], AuxiliarProfile1Resources[Time], AuxiliarProfile2Resources[Time],
		RandomTotalSumOfGRPWToSchedule=0, RandomChoosenNumber=0, RandomCumulative=0, HigherGRPW=0,
		ScheduleIterations=NumberOfTasks, ScheduleDurationFirstConsecutive=0, ScheduleDurationSecondConsecutive=0,   
...
/*INICIALIZO*/											
	for(i=0; i<NumberOfTasks; i++)						{
		...
		State[i]=1,	ScheduleEarlyStart[i]=0, ScheduleStart[i]=0, ScheduleEnd[i]=0, ScheduledTask[i]=0;
...
else if(NumberOfAreas==3)							{
																									
	for(i=0; i<NumberOfTasks; i++)				{
		
		if (ModesPerTask[i]==1)				{
					
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][0], &Duration[i][0], &OperatorsInArea1[i][0], &OperatorsInArea2[i][0], &OperatorsInArea3[i][0], &OperatorsOfProfile1[i][0], &OperatorsOfProfile2[i][0]);
			...
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][0], &Duration[i][0], &OperatorsInArea1[i][0], &OperatorsInArea2[i][0], &OperatorsInArea3[i][0], &OperatorsOfProfile1[i][0], &OperatorsOfProfile2[i][0]);
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][1], &Duration[i][1], &OperatorsInArea1[i][1], &OperatorsInArea2[i][1], &OperatorsInArea3[i][1], &OperatorsOfProfile1[i][1], &OperatorsOfProfile2[i][1]);
			...
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][0], &Duration[i][0], &OperatorsInArea1[i][0], &OperatorsInArea2[i][0], &OperatorsInArea3[i][0], &OperatorsOfProfile1[i][0], &OperatorsOfProfile2[i][0]);
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][1], &Duration[i][1], &OperatorsInArea1[i][1], &OperatorsInArea2[i][1], &OperatorsInArea3[i][1], &OperatorsOfProfile1[i][1], &OperatorsOfProfile2[i][1]);
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][2], &Duration[i][2], &OperatorsInArea1[i][2], &OperatorsInArea2[i][2], &OperatorsInArea3[i][2], &OperatorsOfProfile1[i][2], &OperatorsOfProfile2[i][2]);
			...
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][1], &Duration[i][1], &OperatorsInArea1[i][1], &OperatorsInArea2[i][1], &OperatorsInArea3[i][1], &OperatorsOfProfile1[i][1], &OperatorsOfProfile2[i][1]);
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][2], &Duration[i][2], &OperatorsInArea1[i][2], &OperatorsInArea2[i][2], &OperatorsInArea3[i][2], &OperatorsOfProfile1[i][2], &OperatorsOfProfile2[i][2]);
			fscanf(f, "%d %d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][3], &Duration[i][3], &OperatorsInArea1[i][3], &OperatorsInArea2[i][3], &OperatorsInArea3[i][3], &OperatorsOfProfile1[i][3], &OperatorsOfProfile2[i][3]);
...
for(ScheduleIterations=0; ScheduleIterations<NumberOfTasks; ScheduleIterations++)		{
	...
	for(i=0; i<NumberOfTasks; i++) 	{
			...
			if(State[i]==1&&HigherGRPW<GRPW[i]) 
...
FILE *h;	
	h = fopen("ResultadosGreedyMinimumWorkersGantt.txt","w"); 
...
FILE *t;	
	t= fopen("ResultadosGreedyMinimumWorkersMakespamEvolution.txt","w"); 
...
FILE *y;	
	y= fopen("ResultadosGreedyMinimumWorkersPercentageOccupancy.txt","w"); 
