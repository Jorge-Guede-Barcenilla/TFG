...
for(SolutionIterations=0; SolutionIterations<40000; SolutionIterations++)		{
...
ModesPredeccessor[4]=4, Mode[4][1]=2, Duration[4][1]=3, OperatorsInArea1[4][1]=0, OperatorsInArea2[4][1]=2, OperatorsOfProfile1[4][1]=2, OperatorsOfProfile2[4][1]=0;
...
ModesPredeccessor[81]=81, Mode[81][1]=2, Duration[81][1]=5, OperatorsInArea1[81][1]=2, OperatorsInArea2[81][1]=0, OperatorsOfProfile1[81][1]=0, OperatorsOfProfile2[81][1]=2;
...
ModesPredeccessor[94]=94, Mode[94][1]=2, Duration[94][1]=30, OperatorsInArea1[94][1]=0, OperatorsInArea2[94][1]=0, OperatorsOfProfile1[94][1]=2, OperatorsOfProfile2[94][1]=2;
...
ModesPredeccessor[101]=101, Mode[101][1]=2, Duration[101][1]=18, OperatorsInArea1[101][1]=0, OperatorsInArea2[101][1]=2, OperatorsOfProfile1[101][1]=2, OperatorsOfProfile2[101][1]=0;
...
ModesPredeccessor[108]=108, Mode[108][1]=2, Duration[108][1]=18, OperatorsInArea1[108][1]=2, OperatorsInArea2[108][1]=0, OperatorsOfProfile1[108][1]=0, OperatorsOfProfile2[108][1]=2;
ModesPredeccessor[108]=108, Mode[108][2]=3, Duration[108][2]=12, OperatorsInArea1[108][2]=0, OperatorsInArea2[108][2]=3, OperatorsOfProfile1[108][2]=3, OperatorsOfProfile2[108][2]=0;
...
ModesPredeccessor[101]=101, Mode[101][2]=3, Duration[101][2]=12, OperatorsInArea1[101][2]=3, OperatorsInArea2[101][2]=0, OperatorsOfProfile1[101][2]=0, OperatorsOfProfile2[101][2]=3;
ModesPredeccessor[101]=101, Mode[101][3]=4, Duration[101][3]=9, OperatorsInArea1[101][3]=0, OperatorsInArea2[101][3]=4, OperatorsOfProfile1[101][3]=0, OperatorsOfProfile2[101][3]=4;
...
Duration[4][0]=Duration[4][Mode[4][0]], OperatorsOfProfile1[4][0]=OperatorsOfProfile1[4][Mode[4][0]], OperatorsOfProfile2[4][0]=OperatorsOfProfile2[4][Mode[4][0]], OperatorsInArea1[4][0]=OperatorsInArea1[4][Mode[4][0]], OperatorsInArea2[4][0]=OperatorsInArea2[4][Mode[4][0]];
Duration[81][0]=Duration[81][Mode[81][0]], OperatorsOfProfile1[81][0]=OperatorsOfProfile1[81][Mode[81][0]], OperatorsOfProfile2[81][0]=OperatorsOfProfile2[81][Mode[81][0]], OperatorsInArea1[81][0]=OperatorsInArea1[81][Mode[81][0]], OperatorsInArea2[81][0]=OperatorsInArea2[81][Mode[81][0]];
Duration[94][0]=Duration[94][Mode[94][0]], OperatorsOfProfile1[94][0]=OperatorsOfProfile1[94][Mode[94][0]], OperatorsOfProfile2[94][0]=OperatorsOfProfile2[94][Mode[94][0]], OperatorsInArea1[94][0]=OperatorsInArea1[94][Mode[94][0]], OperatorsInArea2[94][0]=OperatorsInArea2[94][Mode[94][0]];
Duration[157][0]=Duration[157][Mode[157][0]], OperatorsOfProfile1[157][0]=OperatorsOfProfile1[157][Mode[157][0]], OperatorsOfProfile2[157][0]=OperatorsOfProfile2[157][Mode[157][0]], OperatorsInArea1[157][0]=OperatorsInArea1[157][Mode[157][0]], OperatorsInArea2[157][0]=OperatorsInArea2[157][Mode[157][0]];
Duration[101][0]=Duration[101][Mode[101][0]], OperatorsOfProfile1[101][0]=OperatorsOfProfile1[101][Mode[101][0]], OperatorsOfProfile2[101][0]=OperatorsOfProfile2[101][Mode[101][0]], OperatorsInArea1[101][0]=OperatorsInArea1[101][Mode[101][0]], OperatorsInArea2[101][0]=OperatorsInArea2[101][Mode[101][0]];
Duration[108][0]=Duration[108][Mode[108][0]], OperatorsOfProfile1[108][0]=OperatorsOfProfile1[108][Mode[108][0]], OperatorsOfProfile2[108][0]=OperatorsOfProfile2[108][Mode[108][0]], OperatorsInArea1[108][0]=OperatorsInArea1[108][Mode[108][0]], OperatorsInArea2[108][0]=OperatorsInArea2[108][Mode[108][0]];
...
for(k=0; k<NumberOfTasks; k++)	
	...
	printf("Task 4, Mode %d %d %d %d %d\n ", Mode[4][0], OperatorsOfProfile1[4][0], OperatorsOfProfile2[4][0], OperatorsInArea1[4][0], OperatorsInArea2[4][0]);
	printf("Task 81, Mode %d %d %d %d %d\n ", Mode[81][0], OperatorsOfProfile1[81][0], OperatorsOfProfile2[81][0], OperatorsInArea1[81][0], OperatorsInArea2[81][0]);
	printf("Task 94, Mode %d %d %d %d %d\n ", Mode[94][0], OperatorsOfProfile1[94][0], OperatorsOfProfile2[94][0], OperatorsInArea1[94][0], OperatorsInArea2[94][0]);
	printf("Task 157, Mode %d %d %d %d %d\n ", Mode[157][0], OperatorsOfProfile1[157][0], OperatorsOfProfile2[157][0], OperatorsInArea1[157][0], OperatorsInArea2[157][0]);
	printf("Task 101, Mode %d %d %d %d %d\n ", Mode[101][0], OperatorsOfProfile1[101][0], OperatorsOfProfile2[101][0], OperatorsInArea1[101][0], OperatorsInArea2[101][0]);
	printf("Task 108, Mode %d %d %d %d %d\n ", Mode[108][0], OperatorsOfProfile1[108][0], OperatorsOfProfile2[108][0], OperatorsInArea1[108][0], OperatorsInArea2[108][0]);
...
FILE *h;	
	h = fopen("204TasksRandomMode.txt","w"); 
...
FILE *t;	
	t= fopen("204TasksRandomModeMakespamEvolution.txt","w"); 
...
FILE *y;	
	y= fopen("204TasksRandomModePercentageOccupancy.txt","w"); 
