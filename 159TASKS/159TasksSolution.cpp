...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		int NumberOfTasks=0, SolutionIterations=0, NumberOfAreas=0, DesiredSolutions=450, NumberOfProfiles=0, Area1Capacity=0, Area2Capacity=0, Area3Capacity=0, k=0, j=0, i=0, l=0, Aux1=0, Aux2=0, Aux3=0, Aux4=0, Aux5=0, Aux6=0, Aux7=0, Aux8=0,
		...
		float ExecutionTime=0,	StartTime=clock(), EndTime=0;
...
/*ESCANEO DE DATOS Y DE PRECEDENCIAS*/
	...
	fscanf(f,"%d %d %d", &Area1Capacity, &Area2Capacity, &Area3Capacity); 	
		...
		SEED=566, StopCounter=0, Solution=0, Makespam=10000, ScheduleEarlyStart[NumberOfTasks],  NumberOfIteration[DesiredSolutions],
...
for(SolutionIterations=0; SolutionIterations<DesiredSolutions+1; SolutionIterations++)		{
...
/*ESCANEO DE DATOS Y DE PRECEDENCIAS*/
	...
	fscanf(f,"%d %d %d", &Area1Capacity, &Area2Capacity, &Area3Capacity); 	
		...
		ScheduleIterations=300, ScheduleDurationFirstConsecutive=0, ScheduleDurationSecondConsecutive=0,   
	...
	for(i=0; i<NumberOfTasks; i++)						{
		...
		GRPW[i]=0;
			...
			for(j=0; j<aux+1; j++)						{
				 ...
				 IncSuccessor[i][j]=0, PrecedenceSuccessors[i][j]=NumberOfTasks+1, NumberOfThePredeccessor[i][j]=0, Mode[i][j]=0, Duration[i][j]=0, OperatorsInArea1[i][j]=0, OperatorsInArea2[i][j]=0, OperatorsInArea3[i][j]=0, OperatorsOfProfile1[i][j]=0, OperatorsOfProfile2[i][j]=0;
...
if(NumberOfAreas==2)								{
	...
	if (ModesPerTask[i]==1)			 		{							
		...
		else if (ModesPerTask[i]==5)			{
					
			fscanf(f, "%d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][0], &Duration[i][0], &OperatorsInArea1[i][0], &OperatorsInArea2[i][0], &OperatorsOfProfile1[i][0], &OperatorsOfProfile2[i][0]);
			fscanf(f, "%d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][1], &Duration[i][1], &OperatorsInArea1[i][1], &OperatorsInArea2[i][1], &OperatorsOfProfile1[i][1], &OperatorsOfProfile2[i][1]);
			fscanf(f, "%d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][2], &Duration[i][2], &OperatorsInArea1[i][2], &OperatorsInArea2[i][2], &OperatorsOfProfile1[i][2], &OperatorsOfProfile2[i][2]);
			fscanf(f, "%d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][3], &Duration[i][3], &OperatorsInArea1[i][3], &OperatorsInArea2[i][3], &OperatorsOfProfile1[i][3], &OperatorsOfProfile2[i][3]);
			fscanf(f, "%d %d %d %d %d %d %d", &ModesPredeccessor[i], &Mode[i][4], &Duration[i][4], &OperatorsInArea1[i][4], &OperatorsInArea2[i][4], &OperatorsOfProfile1[i][4], &OperatorsOfProfile2[i][4]);
...
/*EL PREDECESOR TIENE QUE HABER TERMINADO*/
			...
			if(NumberOfConsecutiveSuccessors[ScheduledTask[m]]==1) 	{
				...
				AuxiliarProfile1FirstConsecutive=OperatorsInArea1[ConsecutiveSuccessor[ScheduledTask[m]]][0];
				AuxiliarProfile2FirstConsecutive=OperatorsInArea2[ConsecutiveSuccessor[ScheduledTask[m]]][0];
			...
			if(NumberOfConsecutiveSuccessors[ConsecutiveSuccessor[ScheduledTask[m]]]==1) 	{
				...
				AuxiliarProfile1SecondConsecutive=OperatorsInArea1[ConsecutiveSuccessor[ConsecutiveSuccessor[ScheduledTask[m]]]][0];
				AuxiliarProfile2SecondConsecutive=OperatorsInArea2[ConsecutiveSuccessor[ConsecutiveSuccessor[ScheduledTask[m]]]][0];
...
FILE *t;	
	t= fopen("159TasksMakespamEvolution.txt","w"); 
