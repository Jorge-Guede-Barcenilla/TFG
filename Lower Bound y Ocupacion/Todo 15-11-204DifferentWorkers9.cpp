...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		TotalHoursOfWork=0, CicleCharge=0, PercentageLimit=0, LowerBound=0, ModeSelection=0;
	...
	TECLEEOTRAVEZ:													
	printf("Teclee 1 si desea emplear la restriccion Lower Bound o bien introduzca 2 para la restriccion PercentageOccupation\n");
...
if(ModeSelection!=1&&ModeSelection!=2) 	{
	...
	TECLEE:										
	printf("Introduzca numero de operarios de tipo 1 y de tipo 2\n");
	scanf("%d %d", &TotalOperatorsOfProfile1, &TotalOperatorsOfProfile2);

if(TotalOperatorsOfProfile1<5||TotalOperatorsOfProfile2<2)		{
...
for(i=0; i<NumberOfTasks; i++)							{
	...
	if(State[i]==1)									{
		...
		TotalHoursOfWork+=GRPW[i];
		
													}
														}	
	
	printf("Total number of hours is %d", TotalHoursOfWork);
