...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		int NumberOfTasks=204, SolutionIterations=0, NumberOfAreas=0, DesiredSolutions=0, NumberOfProfiles=0, Area1Capacity=0, Area2Capacity=0, Area3Capacity=0, k=0, j=0, i=0, m=0, l=0, Aux1=0, Aux2=0, Aux3=0, Aux4=0, Aux5=0, Aux6=0, Aux7=0, Aux8=0,
...
for(SolutionIterations=0; SolutionIterations<10000; SolutionIterations++)		{
	
NEXTITERATION:
/*INICIALIZO*/											
	for(i=0; i<NumberOfTasks; i++)						{
		
		ScheduleEarlyStart[i]=0, ScheduleStart[i]=0, ScheduleEnd[i]=0, ScheduledTask[i]=0, State[i]=4, ScheduleMakespam=0; /*por defecto todas programadas*/
...
FILE *g;	
	g = fopen("204TasksLocalSearchData.txt","r"); 
...
fscanf(g, "%d", &Area1_1Results[i]);
AuxiliarArea1_1Results[i]=Area1_1Results[i];

fscanf(g, "%d", &Area1_1ResultsTask[i]);
AuxiliarArea1_1ResultsTask[i]=Area1_1ResultsTask[i];
...
fscanf(g, "%d", &Area1_2Results[i]);
AuxiliarArea1_2Results[i]=Area1_2Results[i];

fscanf(g, "%d", &Area1_2ResultsTask[i]);
AuxiliarArea1_2ResultsTask[i]=Area1_2ResultsTask[i];
...
fscanf(g, "%d ", &Area1_3Results[i]);
AuxiliarArea1_3Results[i]=Area1_3Results[i];

fscanf(g, "%d", &Area1_3ResultsTask[i]);
AuxiliarArea1_3ResultsTask[i]=Area1_3ResultsTask[i];
...
fscanf(g, "%d", &Area1_4Results[i]);
AuxiliarArea1_4Results[i]=Area1_4Results[i];

fscanf(g, "%d", &Area1_4ResultsTask[i]);
AuxiliarArea1_4ResultsTask[i]=Area1_4ResultsTask[i];
...
fscanf(g, "%d ", &Area1_5Results[i]);
AuxiliarArea1_5Results[i]=Area1_5Results[i];

fscanf(g, "%d", &Area1_5ResultsTask[i]);
AuxiliarArea1_5ResultsTask[i]=Area1_5ResultsTask[i];
...
fscanf(g, "%d", &Area2_1Results[i]);
AuxiliarArea2_1Results[i]=Area2_1Results[i];

fscanf(g, "%d", &Area2_1ResultsTask[i]);
AuxiliarArea2_1ResultsTask[i]=Area2_1ResultsTask[i];
...
fscanf(g, "%d", &Area2_2Results[i]);
AuxiliarArea2_2Results[i]=Area2_2Results[i];

fscanf(g, "%d", &Area2_2ResultsTask[i]);
AuxiliarArea2_2ResultsTask[i]=Area2_2ResultsTask[i];
...
fscanf(g, "%d", &Area2_3Results[i]);
AuxiliarArea2_3Results[i]=Area2_3Results[i];

fscanf(g, "%d", &Area2_3ResultsTask[i]);
AuxiliarArea2_3ResultsTask[i]=Area2_3ResultsTask[i];

												}

fclose(g);
						
	m=173; /*INDICE QUE DETERMINA ORDEN DE TAREAS*/
/*SELECCION DE MODO*/

ModesPredeccessor[4]=4, Mode[4][0]=1, Duration[4][0]=6, OperatorsInArea1[4][0]=1, OperatorsInArea2[4][0]=0, OperatorsOfProfile1[4][0]=1, OperatorsOfProfile2[4][0]=0;
ModesPredeccessor[4]=4, Mode[4][1]=2, Duration[4][1]=3, OperatorsInArea1[4][1]=2, OperatorsInArea2[4][1]=0, OperatorsOfProfile1[4][1]=2, OperatorsOfProfile2[4][1]=0;
ModesPredeccessor[81]=81, Mode[81][0]=1, Duration[81][0]=10, OperatorsInArea1[81][0]=1, OperatorsInArea2[81][0]=0, OperatorsOfProfile1[81][0]=1, OperatorsOfProfile2[81][0]=0;
ModesPredeccessor[81]=81, Mode[81][1]=2, Duration[81][1]=5, OperatorsInArea1[81][1]=2, OperatorsInArea2[81][1]=0, OperatorsOfProfile1[81][1]=2, OperatorsOfProfile2[81][1]=0;
ModesPredeccessor[94]=94, Mode[94][0]=1, Duration[94][0]=60, OperatorsInArea1[94][0]=1, OperatorsInArea2[94][0]=0, OperatorsOfProfile1[94][0]=1, OperatorsOfProfile2[94][0]=0;
ModesPredeccessor[94]=94, Mode[94][1]=2, Duration[94][1]=30, OperatorsInArea1[94][1]=2, OperatorsInArea2[94][1]=0, OperatorsOfProfile1[94][1]=2, OperatorsOfProfile2[94][1]=0;
ModesPredeccessor[157]=157, Mode[157][0]=1, Duration[157][0]=10, OperatorsInArea1[157][0]=1, OperatorsInArea2[157][0]=0, OperatorsOfProfile1[157][0]=1, OperatorsOfProfile2[157][0]=0;
ModesPredeccessor[157]=157, Mode[157][1]=2, Duration[157][1]=5, OperatorsInArea1[157][1]=2, OperatorsInArea2[157][1]=0, OperatorsOfProfile1[157][1]=2, OperatorsOfProfile2[157][1]=0;
ModesPredeccessor[101]=101, Mode[101][0]=1, Duration[101][0]=36, OperatorsInArea1[101][0]=1, OperatorsInArea2[101][0]=0, OperatorsOfProfile1[101][0]=1, OperatorsOfProfile2[101][0]=0;
ModesPredeccessor[101]=101, Mode[101][1]=2, Duration[101][1]=18, OperatorsInArea1[101][1]=2, OperatorsInArea2[101][1]=0, OperatorsOfProfile1[101][1]=2, OperatorsOfProfile2[101][1]=0;
ModesPredeccessor[108]=108, Mode[108][0]=1, Duration[108][0]=36, OperatorsInArea1[108][0]=1, OperatorsInArea2[108][0]=0, OperatorsOfProfile1[108][0]=1, OperatorsOfProfile2[108][0]=0;
ModesPredeccessor[108]=108, Mode[108][1]=2, Duration[108][1]=18, OperatorsInArea1[108][1]=2, OperatorsInArea2[108][1]=0, OperatorsOfProfile1[108][1]=2, OperatorsOfProfile2[108][1]=0;
ModesPredeccessor[108]=108, Mode[108][2]=3, Duration[108][2]=12, OperatorsInArea1[108][2]=3, OperatorsInArea2[108][2]=0, OperatorsOfProfile1[108][2]=3, OperatorsOfProfile2[108][2]=0;
ModesPredeccessor[108]=108, Mode[108][3]=4, Duration[108][3]=9, OperatorsInArea1[108][3]=4, OperatorsInArea2[108][3]=0, OperatorsOfProfile1[108][3]=4, OperatorsOfProfile2[108][3]=0;
ModesPredeccessor[101]=101, Mode[101][2]=3, Duration[101][2]=12, OperatorsInArea1[101][2]=3, OperatorsInArea2[101][2]=0, OperatorsOfProfile1[101][2]=3, OperatorsOfProfile2[101][2]=0;
ModesPredeccessor[101]=101, Mode[101][3]=4, Duration[101][3]=9, OperatorsInArea1[101][3]=4, OperatorsInArea2[101][3]=0, OperatorsOfProfile1[101][3]=4, OperatorsOfProfile2[101][3]=0;
...
Duration[4][0]=Duration[4][Mode[4][0]], OperatorsOfProfile1[4][0]=OperatorsOfProfile1[4][Mode[4][0]];
Duration[81][0]=Duration[81][Mode[81][0]], OperatorsOfProfile1[81][0]=OperatorsOfProfile1[81][Mode[81][0]];
Duration[94][0]=Duration[94][Mode[94][0]], OperatorsOfProfile1[94][0]=OperatorsOfProfile1[94][Mode[94][0]];
Duration[157][0]=Duration[157][Mode[157][0]], OperatorsOfProfile1[157][0]=OperatorsOfProfile1[157][Mode[157][0]];
Duration[101][0]=Duration[101][Mode[101][0]], OperatorsOfProfile1[101][0]=OperatorsOfProfile1[101][Mode[101][0]];
Duration[108][0]=Duration[108][Mode[108][0]], OperatorsOfProfile1[108][0]=OperatorsOfProfile1[108][Mode[108][0]];

/*INICIALIZACIONDEEARLYSTARTSYSET*/
State[120]=1, State[103]=1, State[175]=1, State[30]=1, State[150]=1, State[158]=1, State[168]=1, State[77]=1;
State[156]=0, State[183]=0, State[66]=0, State[19]=0, State[64]=0, State[124]=0, State[101]=0, State[184]=0, State[152]=0, State[3]=0, State[155]=0, State[106]=0, State[52]=0;
State[15]=0, State[114]=0, State[163]=0, State[79]=0, State[56]=0, State[189]=0, State[4]=0, State[81]=0, State[157]=0, State[187]=0;
ScheduleEarlyStart[120]=729, ScheduleEarlyStart[103]=746, ScheduleEarlyStart[175]=701, ScheduleEarlyStart[30]=523, ScheduleEarlyStart[150]=528, ScheduleEarlyStart[158]=575, ScheduleEarlyStart[168]=606, ScheduleEarlyStart[77]=750;

/*TAREAS DEL LOCAL SEARCH PONER A CERO LOS RECURSOS*/
			for(i=0; i<810; i++)			{

if((State[Area1_1ResultsTask[i]]==1||State[Area1_1ResultsTask[i]]==0)&&Area1_1ResultsTask[i]!=205)
									
										{
Area1_1Results[i]=205;
AuxiliarArea1_1Results[i]=205;
Area1_1ResultsTask[i]=205;
AuxiliarArea1_1ResultsTask[i]=205;										
										}

if((State[Area1_2ResultsTask[i]]==1||State[Area1_2ResultsTask[i]]==0)&&Area1_2ResultsTask[i]!=205)
									
										{
Area1_2Results[i]=205;
AuxiliarArea1_2Results[i]=205;
Area1_2ResultsTask[i]=205;
AuxiliarArea1_2ResultsTask[i]=205;										
										}

if((State[Area1_3ResultsTask[i]]==1||State[Area1_3ResultsTask[i]]==0)&&Area1_3ResultsTask[i]!=205)
									
										{
Area1_3Results[i]=205;
AuxiliarArea1_3Results[i]=205;
Area1_3ResultsTask[i]=205;
AuxiliarArea1_3ResultsTask[i]=205;										
										}

if((State[Area1_4ResultsTask[i]]==1||State[Area1_4ResultsTask[i]]==0)&&Area1_4ResultsTask[i]!=205)
									
										{
Area1_4Results[i]=205;
AuxiliarArea1_4Results[i]=205;
Area1_4ResultsTask[i]=205;
AuxiliarArea1_4ResultsTask[i]=205;										
										}

if((State[Area1_5ResultsTask[i]]==1||State[Area1_5ResultsTask[i]]==0)&&Area1_5ResultsTask[i]!=205)
									
										{
Area1_5Results[i]=205;
AuxiliarArea1_5Results[i]=205;
Area1_5ResultsTask[i]=205;
AuxiliarArea1_5ResultsTask[i]=205;										
										}
...
for(ScheduleIterations=0; ScheduleIterations<32; ScheduleIterations++)		{
...
if(NumberOfConsecutiveSuccessors[ScheduledTask[m]]==0&&State[PrecedenceSuccessors[ScheduledTask[m]][0]]!=4)						{
...
for(k=0; k<NumberOfTasks; k++)	
	...
	printf("Task 4, Mode %d\n ", Mode[4][0]);
	printf("Task 81, Mode %d\n ", Mode[81][0]);
	printf("Task 94, Mode %d\n ", Mode[94][0]);
	printf("Task 157, Mode %d\n ", Mode[157][0]);
	printf("Task 101, Mode %d\n ", Mode[101][0]);
	printf("Task 108, Mode %d\n ", Mode[108][0]);
...
FILE *h;	
	h = fopen("204TasksRandomMode1MillonSolution.txt","w"); 
...
fprintf(h, "Area1_1.Task, Area1_1.TaskBeginning, Area1_1.TaskEnd, Area1_1StartInThisArea, Area1_1EndInThisArea, Area1_1.Worker, Area1_1.NumberOfWorkers, Area1_2.Task, Area1_2.TaskBeginning, Area1_2.TaskEnd, Area1_2StartInThisArea, Area1_2EndInThisArea, Area1_2.Worker, Area1_2.NumberOfWorkers, Area1_3.Task, Area1_3.TaskBeginning, Area1_3.TaskEnd, Area1_3StartInThisArea, Area1_3EndInThisArea, Area1_3.Worker, Area1_3.NumberOfWorkers, Area1_4.Task, Area1_4.TaskBeginning, Area1_4.TaskEnd, Area1_4StartInThisArea, Area1_4EndInThisArea, Area1_4.Worker, Area1_4.NumberOfWorkers, Area1_5.Task, Area1_5.TaskBeginning, Area1_5.TaskEnd, Area1_5StartInThisArea, Area1_5EndInThisArea, Area1_5.Worker, Area1_5.NumberOfWorkers, Area2_1.Task, Area2_1.TaskBeginning, Area2_1.TaskEnd, Area2_1StartInThisArea, Area2_1EndInThisArea, Area2_1.Worker, Area2_1.NumberOfWorkers, Area2_2.Task, Area2_2.TaskBeginning, Area2_2.TaskEnd, Area2_2StartInThisArea, Area2_2EndInThisArea, Area2_2.Worker, Area2_2.NumberOfWorkers, Area2_3.Task, Area2_3.TaskBeginning, Area2_3.TaskEnd, Area2_3StartInThisArea, Area2_3EndInThisArea, Area2_3.Worker, Area2_3.NumberOfWorkers\n");

for(j=0; j<70; j++)									{

	if(j<Aux1&&Area1_1StartInThisArea[j]!=Makespam*2)									{
				
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area1_1ResultsTask[j], AuxiliarSolutionTotalStart[Area1_1ResultsTask[j]], AuxiliarSolutionTotalEnd[Area1_1ResultsTask[j]], Area1_1StartInThisArea[j], Area1_1EndInThisArea[j], 1, OperatorsInArea1[Area1_1ResultsTask[j]][0]);										
												
												}
	
	else if (j>=Aux1)								{
		
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,			", 0, 0, 0, 0, 0, 0, 0);										
																
												}

	if(j<Aux2&&Area1_2StartInThisArea[j]!=Makespam*2)									{
				
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area1_2ResultsTask[j], AuxiliarSolutionTotalStart[Area1_2ResultsTask[j]], AuxiliarSolutionTotalEnd[Area1_2ResultsTask[j]], Area1_2StartInThisArea[j], Area1_2EndInThisArea[j], 2, OperatorsInArea1[Area1_2ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area1_3ResultsTask[j], AuxiliarSolutionTotalStart[Area1_3ResultsTask[j]], AuxiliarSolutionTotalEnd[Area1_3ResultsTask[j]], Area1_3StartInThisArea[j], Area1_3EndInThisArea[j], 3, OperatorsInArea1[Area1_3ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area1_4ResultsTask[j], AuxiliarSolutionTotalStart[Area1_4ResultsTask[j]], AuxiliarSolutionTotalEnd[Area1_4ResultsTask[j]], Area1_4StartInThisArea[j], Area1_4EndInThisArea[j], 4, OperatorsInArea1[Area1_4ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area1_5ResultsTask[j], AuxiliarSolutionTotalStart[Area1_5ResultsTask[j]], AuxiliarSolutionTotalEnd[Area1_5ResultsTask[j]], Area1_5StartInThisArea[j], Area1_5EndInThisArea[j], 5, OperatorsInArea1[Area1_5ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area2_1ResultsTask[j], AuxiliarSolutionTotalStart[Area2_1ResultsTask[j]], AuxiliarSolutionTotalEnd[Area2_1ResultsTask[j]], Area2_1StartInThisArea[j], Area2_1EndInThisArea[j], 6, OperatorsInArea2[Area2_1ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i,		", Area2_2ResultsTask[j], AuxiliarSolutionTotalStart[Area2_2ResultsTask[j]], AuxiliarSolutionTotalEnd[Area2_2ResultsTask[j]], Area2_2StartInThisArea[j], Area2_2EndInThisArea[j], 7, OperatorsInArea2[Area2_2ResultsTask[j]][0]);										
...
fprintf(h,"%i, %i, %i, %i, %i, %i, %i		", Area2_3ResultsTask[j], AuxiliarSolutionTotalStart[Area2_3ResultsTask[j]], AuxiliarSolutionTotalEnd[Area2_3ResultsTask[j]], Area2_3StartInThisArea[j], Area2_3EndInThisArea[j], 8, OperatorsInArea2[Area2_3ResultsTask[j]][0]);										
...
FILE *t;	
	t= fopen("204TasksRandomModeMakespamEvolution1MillonSolution.txt","w"); 
...
FILE *y;	
	y= fopen("204TasksRandomModePercentageOccupancy1MillonSolution.txt","w"); 
