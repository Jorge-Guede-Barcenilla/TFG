...
ModesPredeccessor[4]=4, Mode[4][0]=0, Duration[4][0]=6, OperatorsInArea1[4][0]=1, OperatorsInArea2[4][0]=0, OperatorsOfProfile1[4][0]=1, OperatorsOfProfile2[4][0]=0;
ModesPredeccessor[81]=81, Mode[81][0]=0, Duration[81][0]=10, OperatorsInArea1[81][0]=1, OperatorsInArea2[81][0]=0, OperatorsOfProfile1[81][0]=1, OperatorsOfProfile2[81][0]=0;
ModesPredeccessor[94]=94, Mode[94][1]=1, Duration[94][1]=30, OperatorsInArea1[94][1]=2, OperatorsInArea2[94][1]=0, OperatorsOfProfile1[94][1]=2, OperatorsOfProfile2[94][1]=0;
ModesPredeccessor[157]=157, Mode[157][0]=0, Duration[157][0]=10, OperatorsInArea1[157][0]=1, OperatorsInArea2[157][0]=0, OperatorsOfProfile1[157][0]=1, OperatorsOfProfile2[157][0]=0;
ModesPredeccessor[101]=101, Mode[101][1]=1, Duration[101][1]=18, OperatorsInArea1[101][1]=2, OperatorsInArea2[101][1]=0, OperatorsOfProfile1[101][1]=2, OperatorsOfProfile2[101][1]=0;
ModesPredeccessor[108]=108, Mode[108][2]=2, Duration[108][2]=12, OperatorsInArea1[108][2]=3, OperatorsInArea2[108][2]=0, OperatorsOfProfile1[108][2]=3, OperatorsOfProfile2[108][2]=0;


Duration[94][0]=Duration[94][Mode[94][1]], OperatorsOfProfile1[94][0]=OperatorsOfProfile1[94][Mode[94][1]];
Duration[101][0]=Duration[101][Mode[101][1]], OperatorsOfProfile1[101][0]=OperatorsOfProfile1[101][Mode[101][1]];
Duration[108][0]=Duration[108][Mode[108][2]], OperatorsOfProfile1[108][0]=OperatorsOfProfile1[108][Mode[108][2]];
...
for(ScheduleIterations=0; ScheduleIterations<NumberOfTasks; ScheduleIterations++)		{
	...
	for(i=0; i<NumberOfTasks; i++) 	{
			...
			if(State[i]==1) 	{
				...
				RandomTotalSumOfGRPWToSchedule+=GRPW[i]*((OperatorsOfProfile1[i][0])+OperatorsOfProfile2[i][0]);
...
for(i=0; i<NumberOfTasks; i++) 							{
	...
	if(State[i]==1) 									{
		RandomCumulative+=GRPW[i]*((OperatorsOfProfile1[i][0])+OperatorsOfProfile2[i][0]);
	
	if(i==123||i==28||i==178||i==174||i==11||i==86) {
...
FILE *h;	
	h = fopen("204TasksRandomMode1MillonFixedMode.txt","w"); 
...
FILE *t;	
	t= fopen("204TasksRandomModeMakespamEvolution1MillonFixedMode.txt","w"); 
...
FILE *y;	
	y= fopen("204TasksRandomModePercentageOccupancy1MillonFixedMode.txt","w"); 
