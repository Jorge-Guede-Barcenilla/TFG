...
for(SolutionIterations=0; SolutionIterations<800000; SolutionIterations++)		{
...
if(SolutionIterations>700000) {
												
FILE *j;	
	j = fopen("204TasksLocalSearchData.txt","w"); 
...
fprintf(j, "%d ", Area1_1Results[i]);
fprintf(j, "%d\t", Area1_1ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area1_2Results[i]);
fprintf(j, "%d\t", Area1_2ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area1_3Results[i]);
fprintf(j, "%d\t", Area1_3ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area1_4Results[i]);
fprintf(j, "%d\t", Area1_4ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area1_5Results[i]);
fprintf(j, "%d\t", Area1_5ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area2_1Results[i]);
fprintf(j, "%d\t", Area2_1ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area2_2Results[i]);
fprintf(j, "%d\t", Area2_2ResultsTask[i]);
												}
...
fprintf(j, "%d ", Area2_3Results[i]);
fprintf(j, "%d\t", Area2_3ResultsTask[i]);
												}
...
/*ALMACENAMIENTO DEL VECTOR DE RECURSOS*/
FILE *t;	
	t = fopen("204TasksLocalSearchDataResources.txt","w"); 
...
fprintf(t, "%d ", Profile1Resources[i]);
											}
...
fprintf(t, "%d ", Profile2Resources[i]);
											}
fclose(t);
...
FILE *h;	
	h = fopen("204TasksRandomMode1Millon.txt","w"); 
...
FILE *t;	
	t= fopen("204TasksRandomModeMakespamEvolution1Millon.txt","w"); 
...
FILE *y;	
	y= fopen("204TasksRandomModePercentageOccupancy1Millon.txt","w"); 
