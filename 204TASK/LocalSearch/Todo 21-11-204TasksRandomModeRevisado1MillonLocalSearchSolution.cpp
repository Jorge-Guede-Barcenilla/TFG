...
ScheduleEarlyStart[120]=729, ScheduleEarlyStart[103]=746, ScheduleEarlyStart[175]=731, ScheduleEarlyStart[30]=731, ScheduleEarlyStart[150]=731, ScheduleEarlyStart[158]=731, ScheduleEarlyStart[168]=731, ScheduleEarlyStart[77]=731;

for (i=0; i<732; i++) 										{
	
Profile1Resources[i]=0;
AuxiliarProfile1Resources[i]=0;
									}


for (i=731; i<807; i++) 		{
	
	if(i>=731&&i<=734||i>=738&&i<=742||i>=745&&i<=749||i==762) 
						{
	
Profile1Resources[i]=2;
AuxiliarProfile1Resources[i]=2;
	
						}
																
	else if(i==743||i==744||i>=735&&i<=737) 
						{
	
Profile1Resources[i]=1;
AuxiliarProfile1Resources[i]=1;
	
						}															

	else if(i==752||i>=794&&i<=803||i==806)
	
						{
	
Profile1Resources[i]=5;
AuxiliarProfile1Resources[i]=5;
	
						}			
																		
	else if(i==763||i>=765&&i<=767||i>=785&&i<=790)
						{
	
Profile1Resources[i]=3;
AuxiliarProfile1Resources[i]=3;
	
						}															
else					{
	Profile1Resources[i]=4;
AuxiliarProfile1Resources[i]=4;
