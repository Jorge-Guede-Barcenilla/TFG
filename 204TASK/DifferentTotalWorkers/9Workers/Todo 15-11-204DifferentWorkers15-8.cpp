...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		TotalOperatorsOfProfile1=30, TotalOperatorsOfProfile2=20, OperatorsInArea1[NumberOfTasks][aux], OperatorsInArea2[NumberOfTasks][aux], MinimumOperators[NumberOfTasks], MaximumOperators[NumberOfTasks],
