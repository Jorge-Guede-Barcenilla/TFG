...
/*DECLARACION DE VARIABLES*/
	int main() 													{	
		...
		TotalOperatorsOfProfile1=9, TotalOperatorsOfProfile2=5, OperatorsInArea1[NumberOfTasks][aux], OperatorsInArea2[NumberOfTasks][aux], MinimumOperators[NumberOfTasks], MaximumOperators[NumberOfTasks],
