...
FILE *h;	
	h = fopen("204TasksMaximumWorkersMode.txt","w"); 
...
FILE *t;	
	t= fopen("204TasksMaximumWorkersModeMakespamEvolution.txt","w"); 
...
FILE *y;	
	y= fopen("204TasksMaximumWorkersModePercentageOccupancy.txt","w"); 
