...
# Read in data
df <- read.csv("C:/Users/Jorge/Desktop/TFG 10 NOV Resultados/204TASK/AlternativeMinimumMaximumWorkersMode/204TasksAlternativeMinimumMaximumWorkersMode.txt", stringsAsFactors = F)
