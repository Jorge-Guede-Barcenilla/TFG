...
# Read in data
df <- read.csv("C:/Program Files (x86)/Dropbox/Client/jorge_guede/TFG RESULTADOS/204 TASKS/MinimumWorkersMode/204TasksMinimumWorkersMode.txt", stringsAsFactors = F)
